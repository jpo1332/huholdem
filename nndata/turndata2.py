...
def turn_function(session1, game1, turn, rounds):
        ...
        if turn == False:
            ...
            if rounds == 3:
                ...
                x = [[prob, difference] + [session1.player1.previousmove, session1.bblind]]
                move = secondplayersess1.run(predict_op1, feed_dict={X: x})
                '''
                if com < 1.4:
                    move = 1
                if com < - .8:
                ...
                difference = game1.secondplayer.handscore.type - game1.community.handscore.type
                x = [[prob, difference] + [session1.player1.previousmove, session1.bblind]]
                move = secondplayersess2.run(predict_op1, feed_dict={X: x})
                '''
                if com < 1.4:
                    move = 1
                if com < - 1.9:
...
runs = 90000
rivernndata = open("turnnn2data.csv", 'w')
